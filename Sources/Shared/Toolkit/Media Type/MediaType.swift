...
//    }
    ...
    public init?(_ string: String, name: String? = nil, fileExtension: String? = nil) {
        ...
        type = types[0].lowercased()
        subtype = types[1].lowercased()
